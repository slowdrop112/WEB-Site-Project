...
CREATE USER cristian WITH ENCRYPTED PASSWORD 'maimuta112';
GRANT ALL PRIVILEGES ON DATABASE cti_2024 TO cristian ;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO cristian;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO cristian;