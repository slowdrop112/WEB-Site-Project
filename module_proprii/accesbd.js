...
class AccesBD{
    ...
    initLocal(){
        this.client= new Client({database:"cti_2024",
            ...
            password:"maimuta112", 
            host:"localhost", 
            port:8080}); //eu am dat ca portul la postgres sa fie 8080 la instalare
...
//daca nu exista creeaza instanta, daca exista o returneaza


    /**
     * @ttypedef {object} ObiectQuerySelect - obiect primit de functiile care realizeaza un query
     ...
     * @propery {string[]} conditiiAnd - lista de stringuri cu conditii pentru where
     */
